...
|---------|--------------|
| **1.6.1** | เพิ่ม นครราชสีมา (30, 32 อำเภอ) + ขอนแก่น (40, 26 อำเภอ) ใน `AMPHUR_FEE_TABLE` รวมเป็น 245 อำเภอ 17 จังหวัด multi-field. `enabledProvinces` 20 จังหวัด. หมายเหตุ: db ใช้ "โคกโพธิ์ไชย" (ไชย) ส่วน sheet ใช้ "โคกโพธิ์ชัย" (ชัย) — แมป amphurID 4022 |
